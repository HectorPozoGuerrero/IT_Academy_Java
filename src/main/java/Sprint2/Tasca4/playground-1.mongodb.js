...
db.Restaurants.find({'grades.1.grade': 'A', 'grades.1.score': 9, 'grades.1.date': ISODate('2014-08-11T00:00:00Z')}, {restaurant_id: 1, name: 1, grades: {$slice: [1, 1]}, _id: 0})
...
db.Restaurants.find({$or: [{'address.street': {$exists: false}}, {'address.street': null}]})
